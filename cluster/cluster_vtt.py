...
def main(argv):
    ...
    for i in range(s,e,step):
        ...
        f.write("python process_features2.py /p/work2/projects/ryat/datasets/vid-desc/vtt/frames/ /p/work2/projects/ryat/datasets/vid-desc/vtt/features_resnet/ '.mp4' "+str(start)+" "+str(end))
        f.close()
